...
const Hero = () => {
    return (
        <div id="hero" className='flex flex-col-reverse items-center justify-center mt-12 md:flex-row md:mt-0 space-y-8 md:space-y-0'> {/* Adjusted layout for mobile and larger screens */}
