...
const EButton = () => {
  return (
    <div className="grid place-content-center mt-5">
      <a href="https://drive.google.com/file/d/1rYDvULmTowRhNol6AlKIQOWFDS5uA5HV/view?usp=sharing" target = "_blank">
        <EncryptButton />
      </a>
      <span className="text-white text-center">Hover this :)</span>
    </div>
  );
};
